...
cs557::ModelBRDF  sphere_01;
cs557::ModelBRDF  sphere_02;
cs557::ModelBRDF  sphere_03;
cs557::ModelBRDF  sphere_04;

cs557::ModelBRDF  sphere_11;
cs557::ModelBRDF  sphere_12;
cs557::ModelBRDF  sphere_13;
cs557::ModelBRDF  sphere_14;
...
void Init(void)
{
	...
	// This line loads the sphere models. 
    sphere_01.create("../sphere_t.obj", brdf0);
    sphere_02.create("../sphere_t.obj", brdf1);
    sphere_03.create("../sphere_t.obj", brdf2);
    sphere_04.create("../sphere_t.obj", brdf3);

    sphere_11.create("../sphere_t.obj", brdf11);
    sphere_12.create("../sphere_t.obj", brdf12);
    sphere_13.create("../sphere_t.obj", brdf13);
    sphere_14.create("../sphere_t.obj", brdf14);
